...
```
index.md                        → entrada única
memoria/wiki.md                 → este arquivo (conceito central)
infra/                          → infraestrutura
  hermes.md                     → identidade, regras, stack
  vps.md                        → Docker, Swarm, Traefik, IPVS
conhecimento/firecrawl.md       → busca multi-plataforma
historico/crise-update.md       → sessão de recuperação
pendencias/proximos-passos.md   → o que falta fazer
```
